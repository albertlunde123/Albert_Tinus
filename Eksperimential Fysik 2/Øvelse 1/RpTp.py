...
fre.plot_chi(Tp_vinkler, Tp_intens, err, ax, fre.Tp, 0.60, 0.08, '#e1341e', 'white')
fre.plot_chi(Rp_vinkler, Rp_intens, err, ax, fre.Rp, 0.60, 0.08, '#fff000', "white")
...
ax.set_title("Intensities of P-polarized light", fontsize = 20, color = 'white')
