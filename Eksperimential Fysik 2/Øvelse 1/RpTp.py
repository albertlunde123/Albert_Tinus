# Plot af Rp og Tp, hvor disse sammenlignes med de teoretiske kurver.
...
fre.plot_chi(Tp_vinkler, Tp_intens, err, ax, fre.Tp, 0.60, 0.08, '#e1341e', '#fff000')
fre.plot_chi(Rp_vinkler, Rp_intens, err, ax, fre.Rp, 0.60, 0.08, '#fff000', "#e1431e")
...
ax.set_title("Intensities of P-polarized light", fontsize = 16, color = 'white')
