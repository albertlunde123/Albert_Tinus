...
Tp_intens = Tp_data[:,3]/2.869
Rp_intens = Rp_data[:,2]/2.869

err = 0.5*fre.deg_to_rad

# fre.plot_chi(Tp_vinkler, Tp_intens, err, ax, fre.Tp, 0.61, '#edcfa4')
fre.plot_curvefit(Tp_vinkler, Rp_vinkler, Tp_intens, Rp_intens, err, ax, fre.Ts, fre.Rs, 0.61, "#fff000")
...
ax.set_title("Sum of S-polarized light", fontsize = 20, color = 'white')
