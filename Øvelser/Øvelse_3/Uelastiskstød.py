...
# puk.plot_Puks_xy([puk1, puk2], ax, ['ro', 'bo'])
...
def newObject(puk1,puk2):
   ...
   # find ændringen i vinkel
    ...
    return [M, I, puk1.get_center(0)[tindex:], centerx, centery, angles, [puk1.get_center(0)[tindex:],
                                                                     puk1.get_center(1)[tindex:],
                                                puk1.get_center(2)[tindex:]]]
